var G={name:"JS SDK",version:"2.0.0",owner:"GeoHey.com"};window.G=G;var cons=window.console;cons&&(cons.log("%c","font-size:30px; padding:15px 120px;line-height:60px;background:url('http://static.geohey.com/img/logo-all.png') no-repeat;"),cons.log(G.name,G.version,"\u00a9",G.owner));
