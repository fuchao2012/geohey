var G={name:"Mlog",version:"1.0.0",owner:"mlogcn.com",author:"fuchao"};window.G=G;var cons=window.console;cons&&(cons.log("%c","font-size:30px; padding:15px 120px;line-height:60px;background:url('http://www.mlogcn.com/images/sprite.png') -362px -446px no-repeat;"),cons.log(G.name,G.version,"\u00a9",G.owner,G.author));
...
1].src,c=b.lastIndexOf("/");G.debug=0<b.toLowerCase().lastIndexOf(".min.js")?!1:!0;G.dir=0>c?"":b.substring(0,c+1);var d=document.getElementsByTagName("head")[0],e={},f={};G.loadModule=function(b,c,d){a(G.dir+"g-"+b+(G.debug?"":".min")+".js",c,d)};G.loadModules=function(a,b,c){var d=0,e=!1,f,p;for(f in a)p=a[f],G.loadModule(p,function(){d++;e||d===a.length&&b&&b()},function(){e=!0;c&&c()})}})();
G.Util={isArray:function(a){return"[object Array]"===Object.prototype.toString.call(a)},isString:function(a){return"[object String]"===Object.prototype.toString.call(a)},isFunction:function(a){return"[object Function]"===Object.prototype.toString.call(a)},merge:function(a){var b=Array.prototype.slice.call(arguments,1),c,d,e,f;d=0;for(e=b.length;d<e;d++)for(c in f=b[d]||{},f)f.hasOwnProperty(c)&&(a[c]=f[c]);return a},bind:function(a,b){var c=2<arguments.length?Array.prototype.slice.call(arguments,
2):null;return function(){return a.apply(b,c||arguments)}},_stampId:0,stamp:function(a){a._g_id_=a._g_id_||this._stampId++;return a._g_id_},trim:function(a){return a.trim?a.trim():a.replace(/^\s+|\s+$/g,"")},renderString:function(a,b){return a?a.replace(/\{ *([\w]+) *\}/gi,function(a,d){var e=b[d];return void 0===e?"":e}):""},_requestAnimFrameFunc:function(){for(var a=["webkit","moz","o","ms"],b=window.requestAnimationFrame,c=0,d=a.length;c<d&&!b;c++)b=window[a[c]+"RequestAnimationFrame"];return b}(),
requestAnimFrame:function(a,b,c,d){a=this.bind(a,c);if(c=this._requestAnimFrameFunc)return c.call(window,a,d);if(b)a();else return window.setTimeout(a,16)},_cancelAnimFrameFunc:function(){for(var a=["webkit","moz","o","ms"],b=window.cancelAnimationFrame,c=0,d=a.length;c<d&&!b;c++)b=window[a[c]+"CancelAnimationFrame"]||window[a[c]+"CancelRequestAnimationFrame"];return b}(),cancelAnimFrame:function(a){var b=this._cancelAnimFrameFunc;b?b.call(window,a):window.clearTimeout(a)},setCanvasLineDash:function(a,
b){a&&b&&0<b.length&&(a.setLineDash?a.setLineDash(b):void 0!==a.webkitLineDash?a.webkitLineDash=b:void 0!==a.mozDash&&(a.mozDash=b))},ajax:function(a,b){if(a){var c=b||{},d=c.context||this,e=function(a,b,c){if(void 0===b||void 0===c)return a;a+=a.match(/\?/)?"&":"?";return a+(b+"="+c)},f=function(a){v&&v.call(d,a)},h="POST"===(c.type||"GET").toUpperCase()?"POST":"GET",k=c.contentType,l=c.headers||{},n=c.data||{},m=(c.responseType||"DATA").toUpperCase(),r=c.jsonp||"_g_jsonp_"+this._ajaxSeq++,p=c.jsonpCallback||
"callback",q=c.success,w=c.error,v=c.complete,x,s,h="JSONP"===m?"GET":h;if("GET"===h){for(x in n)a=e(a,x,n[x]);n=null}else{c="";for(x in n)c=e(c,x,n[x]);"?"===c[0]&&(c=c.slice(1));n=c;k=k||"application/x-www-form-urlencoded; charset=UTF-8"}if("JSONP"===m)return a=e(a,p,r),s=document.createElement("script"),s.src=a,s._g_jsonp_=r,window[r]=function(a){s._g_jsonp_value_=a;window[r]=null;s.parentNode&&s.parentNode.removeChild(s)},e=function(){s._g_abort_||(s.readyState&&"loaded"!=s.readyState&&"complete"!=
s.readyState||s.success)||(s.success=!0,q&&q.call(d,s,s._g_jsonp_value_),f(s))},"onload"in s?s.onload=e:s.onreadystatechange=e,s.onerror=function(){w&&w.call(d,s);f(s)},document.getElementsByTagName("head")[0].appendChild(s),s;var u=window.XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.XMLHTTP");if(u){u.onload=function(){if(4==u.readyState){if(200==u.status||304==u.status){var a;a="TEXT"===m?u.responseText:"XML"===m?u.responseXML:"JSON"===m?eval("("+u.responseText+")"):u.response;
q&&q.call(d,u,a)}else w&&w.call(d,u);f(u)}};u.onerror=function(){w&&w.call(d,u);f(u)};u.open(h,a,!0);k&&u.setRequestHeader("Content-Type",k);for(x in l)u.setRequestHeader(x,l[x]);u.send(n);return u}}},ajaxCancel:function(a){a&&(a.onload=a.onerror=null,a.abort?a.abort():(a._g_abort_=!0,a.parentNode&&a.parentNode.removeChild(a)))},colorHex:function(a,b,c){function d(a){return("0"+parseInt(a).toString(16)).slice(-2)}return"#"+d(a)+d(b)+d(c)},colorRgb:function(a){function b(a,b,e){a=parseInt(a.substring(b,
e),16);return 2===e-b?a:256-(16-a)*(16-a)}return 5>a.length?[b(a,1,2),b(a,2,3),b(a,3,4)]:[b(a,1,3),b(a,3,5),b(a,5,7)]},_ajaxSeq:0};
...
{i:""})}};
(function(){var a=window,b=document,c=a.navigator,d=c.userAgent.toLowerCase(),e=b.documentElement,f="undefined"!==typeof a.orientation,h=-1<d.search("iphone"),k=-1<d.search("android"),l=-1<d.search("android [23]"),n="ActiveXObject"in window,m=n&&!b.addEventListener,r=-1<d.search("webkit"),p=-1<d.search("chrome"),q=-1<d.search("safari/")&&!p,w=-1<d.search("gecko/")&&!r&&!n,v=!!b.createElementNS&&!!b.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect,x=!!b.createElement("canvas").getContext,s;
...
document instanceof a.DocumentTouch,a=1.5<=a.devicePixelRatio||a.matchMedia&&a.matchMedia("(-webkit-min-device-pixel-ratio: 1.5),                      (-moz-min-device-pixel-ratio: 1.5),                      (min-device-pixel-ratio: 1.5),                      (min-resolution: 1.5dppx)").matches;G.Util.merge(G.Browser,{mobile:f,iphone:h,android:k,androidlt3:l,ie:n,ielt9:m,webkit:r,safari:q,chrome:p,gecko:w,svg:v,vml:m,canvas:x,webgl:s,avoidCanvas:d,ie3d:b,webkit3d:u,gecko3d:y,opera3d:e,support3d:z,
...
G.Event={eventsKey:"_g_events_",virtualMouse:{DOWN:G.Browser.touch?["touchstart","mousedown"]:["mousedown"],MOVE:{mousedown:"mousemove",touchstart:"touchmove",MSPointerDown:"touchmove"},UP:{mousedown:"mouseup",touchstart:"touchend",MSPointerDown:"touchend"}},addListener:function(a,b,c){b={action:b,context:c||this};c=this.eventsKey;c=this[c]=this[c]||{};c[a]=c[a]||[];c[a].push(b);return this},removeListener:function(a,b,c){var d=this[this.eventsKey];if(!d)return this;if(b){if(a=d[a])for(d=a.length-
1;0<=d;d--)a[d].action!==b||c&&a[d].context!==c||a.splice(d,1)}else delete d[a];return this},clearListeners:function(){delete this[this.eventsKey];return this},hasListeners:function(a){var b=this[this.eventsKey];return b?a in b&&0<b[a].length:!1},fireEvent:function(a,b){if(!this.hasListeners(a))return this;var c=this[this.eventsKey],d=G.Util.merge({},b,{type:a,target:this,cancel:function(){d._cancel=!0;return d}});if(c)for(var e=c[a],f=e.length-1;0<=f&&!d._cancel;f--)(c=e[f].action)&&c.call(e[f].context||
this,d);return this}};G.Event.bind=G.Event.addListener;G.Event.unbind=G.Event.removeListener;G.Event.fire=G.Event.fireEvent;
...
a.setAttribute("stop-color",b),a.setAttribute("stop-opacity",c));return d},createVML:function(a,b,c){this._vml_init||(document.namespaces.add("v","urn:schemas-microsoft-com:vml"),this._vml_init=!0);a=document.createElement("<v:"+a+">");a.className=b||"";c&&c.appendChild(a);return a},strokeVML:function(a,b){var c=a._stroke,d="color dashstyle endcap joinstyle weight opacity".split(" "),e,f;if(b)for(e in c||(c=a._stroke=this.createVML("stroke","g-vml",a)),d)f=d[e],f in b&&(c[f]=b[f]);else c&&(a.removeChild(c),
a._stroke=null)},fillVML:function(a,b){var c=a._fill,d="color color2 opacity src focusposition type".split(" "),e,f;if(b)for(e in c||(c=a._fill=this.createVML("fill","g-vml",a)),d)f=d[e],f in b&&(c[f]=b[f]);else c&&(a.removeChild(c),a._fill=null)},get:function(a){return G.Util.isString(a)?document.getElementById(a):a},getDomEventKey:function(a,b,c){return"_g_dom_event_"+a+"_"+G.Util.stamp(b)+(c?"_"+G.Util.stamp(c):"")},addListener:function(a,b,c,d){var e=G.DomUtil.getDomEventKey(b,c,d),f=a[e];if(f)return this;
f=function(b){return c.call(d||a,b)};"addEventListener"in a?a.addEventListener(b,f,!1):"attachEvent"in a&&a.attachEvent("on"+b,f);a[e]=f;return this},removeListener:function(a,b,c,d){c=G.DomUtil.getDomEventKey(b,c,d);d=a[c];if(!d)return this;"removeEventListener"in a?a.removeEventListener(b,d,!1):"detachEvent"in a&&a.detachEvent("on"+b,d);a[c]=null;return this},getMousePosition:function(a,b){var c=a.touches?0<a.touches.length?a.touches[0]:a.changedTouches[0]:a,d=document.documentElement,e=document.body,
...
G.DomDraggable=G.Class.extend({mixins:[G.Event],init:function(a,b){this._element=a;this._dragStartTarget=b||a},on:function(){var a=G.DomUtil,b=this.virtualMouse;if(!this._enabled){for(var c in b.DOWN)a.addListener(this._dragStartTarget,b.DOWN[c],this._onDown,this);this._enabled=!0}return this},off:function(){var a=G.DomUtil,b=this.virtualMouse;if(this._enabled){for(var c in b.DOWN)a.removeListener(this._dragStartTarget,b.DOWN[c],this._onDown,this);this._enabled=!1}this._dragged=!1;return this},_onDown:function(a){if(!a.shiftKey&&
(1===a.which||1===a.button||a.touches)){var b=G.DomUtil;if(!G.DomDraggable.forbidden&&!this._dragging){for(var c=(a||a.touches[0]).target;c;){if("g-popup"==c.className)return;c=c.parentElement}b.stopPropagation(a);b.preventDefault(a);b.disableImageDrag();b.disableTextSelection();c=a.touches?a.touches[0]:a;this._dragged=!1;this._startClientX=c.clientX;this._startClientY=c.clientY;c=[0,0];this._startX=this._newX=c[0];this._startY=this._newY=c[1];c=this.virtualMouse;b.addListener(document,c.MOVE[a.type],
this._onMove,this);b.addListener(document,c.UP[a.type],this._onUp,this)}}},_onMove:function(a){if(!(a.touches&&1<a.touches.length)){var b=G.Util,c=G.DomUtil,d=a.touches&&1===a.touches.length?a.touches[0]:a,e=d.clientX-this._startClientX,d=d.clientY-this._startClientY;if(e||d){var f,h,k,l;this._dLimit&&4==this._dLimit.length&&(f=Math.min(this._dLimit[0],0),h=Math.max(this._dLimit[1],0),k=Math.max(this._dLimit[2],0),l=Math.min(this._dLimit[3],0),e=Math.min(Math.max(e,f),k),d=Math.min(Math.max(d,l),
h));c.stopPropagation(a);c.preventDefault(a);this._dragged||(this._dragged=!0,this.fireEvent("dragStart"),c.addClass(document.body,"g-dragging"));this._newX=this._startX+e;this._newY=this._startY+d;this._dragging=!0;b.cancelAnimFrame(this._animRequest);this._animRequest=b.requestAnimFrame(this._updatePosition,!0,this,this._dragStartTarget)}}},_updatePosition:function(){var a=G.DomUtil,b=this._element;a.markPosTransform(b,this._newX,this._newY);a.updateTransform(b);this.fireEvent("drag")},_onUp:function(){var a=
G.DomUtil,b=this.virtualMouse;a.removeClass(document.body,"g-dragging");for(var c in b.MOVE)a.removeListener(document,b.MOVE[c],this._onMove,this),a.removeListener(document,b.UP[c],this._onUp,this);a.enableImageDrag();a.enableTextSelection();this._dragging&&(this._dragging=!1,G.Util.cancelAnimFrame(this._animRequest),this.fireEvent("dragEnd"))}});
...
G.GeomUtil={geomType:function(a){var b=G.Util;if(b.isArray(a))return this._singleGeomType(a);if((a=a.m)&&b.isArray(a[0]))return"Multi"+this._singleGeomType(a[0])},centroid:function(a){var b=this._singleGeomType(a),c=0,d=0,e=0,f,h,k,l;if("Extent"==b)return[(a[0]+a[2])/2,(a[1]+a[3])/2];if("Point"==b||"Circle"==b)return[a[0],a[1]];if("Polyline"==b){b=0;for(f=a.length;b<f-1;b++)h=a[b],k=a[b+1],l=G.MathUtil.calcHypotenuse(h[0]-k[0],h[1]-k[1]),c+=(h[0]+k[0])/2*l,d+=(h[1]+k[1])/2*l,e+=l;return[c/e,d/e]}if("Polygon"==
b){b=0;for(f=a.length;b<f;b++)k=a[b],h=this._islandCentroid(k),k=this._islandArea(k)*(0==b?1:-1),c+=h[0]*k,d+=h[1]*k,e+=k;return[c/e,d/e]}},labelPoint:function(a){var b=this._singleGeomType(a),c=this.centroid(a);if("Extent"==b||"Point"==b||"Circle"==b)return c;if("Polyline"==b)return this._hitPolyline(c,a)?c:this._nearestOfPolyline(c,a);if("Polygon"==b)return this._hitPolygon(c,a)?c:this._nearestOfPolyline(c,1<a.length?a[1]:a[0])},_singleGeomType:function(a){var b=G.Util;if(b.isArray(a[0]))return b.isArray(a[0][0])?
"Polygon":"Polyline";if(4==a.length)return"Extent";if(3==a.length)return"Circle";if(2==a.length)return"Point"},_middlePoint:function(a,b){return[(a[0]+b[0])/2,(a[1]+b[1])/2]},_closestToPoint:function(a,b,c){var d=b[0];b=b[1];var e=c[0]-d,f=c[1]-b,h=e*e+f*f;0<h&&(a=((a[0]-d)*e+(a[1]-b)*f)/h,1<a?(d=c[0],b=c[1]):0<a&&(d+=e*a,b+=f*a));return[d,b]},_nearestOfPolyline:function(a,b){for(var c,d,e,f=Number.MAX_VALUE,h=0,k=b.length-1;h<k;h++)c=b[h],d=b[h+1],sqrDis=this._sqrDistToPoint(a,c,d),sqrDis<f&&(e=
[c,d],f=sqrDis);return e?this._closestToPoint(a,e[0],e[1]):b[0]},_sqrDist:function(a,b){var c=a[0]-b[0],d=a[1]-b[1];return c*c+d*d},_sqrDistToPoint:function(a,b,c){b=this._closestToPoint(a,b,c);return this._sqrDist(a,b)},_hitPolyline:function(a,b,c){var d,e;c=(c||0)*(c||0);for(var f=0,h=b.length-1;f<h;f++)if(d=b[f],e=b[f+1],d=this._sqrDistToPoint(a,d,e),d<=c)return!0;return!1},_hitPolygon:function(a,b){var c=!1,d,e,f,h,k;d=0;for(iLen=b.length;d<iLen;d++)for(f=b[d],e=0,jLen=f.length;e<jLen;e++){h=
f[e];if(h[0]===a[0]&&h[1]===a[1])return!0;k=e===jLen-1?f[0]:f[e+1];h[1]>a[1]!==k[1]>a[1]&&a[0]<(k[0]-h[0])*(a[1]-h[1])/(k[1]-h[1])+h[0]&&(c=!c)}return c},_islandCentroid:function(a){var b=0,c=0,d=0,e,f,h;e=0;for(f=a.length;e<f;e++)h=a[e],b+=h[0],c+=h[1],d++;return[b/d,c/d]},_islandArea:function(a){var b,c,d,e=a.length,f=0;if(3>e)return 0;for(d=0;d<e-1;d++)b=a[d],c=a[d+1],f+=this._vectorArea(b,c);f+=this._vectorArea(a[e-1],a[0]);return Math.abs(f)},_vectorArea:function(a,b){var c=G.MathUtil,d=c.calcTheta(a[0],
a[1])-G.MathUtil.calcTheta(b[0],b[1]),e=c.calcHypotenuse(a[0],a[1]),c=c.calcHypotenuse(b[0],b[1]);return e*c*Math.sin(d)/2}};
...
d.vertexSize],outline:!0,outlineColor:d.vertexColor,outlineDashArray:d.vertexDashArray,outlineWidth:d.vertexOutlineWidth,outlineOpacity:1,fill:!1,clickable:!0}),f._isVertex=!0,f._idVertex=e,f._isMid=!0,f._graphic=this,f.addTo(this._layer));c._requestRedraw()},_onVertexDragStart:function(a){var b=this._layer._map,c=[a.mapX,a.mapY],d=this.virtualMouse,e=G.DomUtil,f=this._searchVertex(c);if(f){var h=b._handlers.Click;h&&h.off();var k=[f.geom[0],f.geom[1]],h=f._idVertex,l=[0,0];b.options.wrap&&(k=b._calcRealCoords(c),
l[0]=k[0]-c[0],l[1]=k[1]-c[1],k=[k[0]+l[0],k[1]+l[1]]);f._isMid&&(f=this.geom.slice(0,h),f=f.concat([k]),this.geom=f=f.concat(this.geom.slice(h)),this._refreshVertexes(),f=this._searchVertex(c));this._drag={vertex:f,wrapOffset:l,startAt:+new Date};e.stopPropagation(a);e.preventDefault(a);b._handlers.Drag.off();b.addListener(d.MOVE[a.type],this._onVertexDrag,this);b.addListener(d.UP[a.type],this._onVertexDragEnd,this)}},_onVertexDrag:function(a){var b=this._layer._map,c=this._drag,d;if(c&&(d=c.vertex))for(wrapOffset=
c.wrapOffset||[0,0],a=b._calcRealCoords([a.mapX,a.mapY]),b=[a[0]+wrapOffset[0],a[1]+wrapOffset[1]],a=d._idVertex,this.geom[a]=d.geom=b,this.updateGeom(),d.updateGeom(),b=a;b<=a+1;b++)if(d=this._midvertexes[b])d.geom=G.GeomUtil._middlePoint(this.geom[b-1],this.geom[b]),d.updateGeom()},_onVertexDragEnd:function(a){var b=this._layer._map,c=this.virtualMouse,d=G.DomUtil,e=b._handlers.Click;if(e)e.on();var e=this._drag,f;e&&(d.stopPropagation(a),d.preventDefault(a),b._handlers.Drag.on(),f=e.vertex)&&(d=
f._idVertex,e=+new Date-e.startAt,200>e&&!f._isMid&&2<this.geom.length?(e=this.geom.slice(0,d),this.geom=e=e.concat(this.geom.slice(d+1)),this.updateGeom(),this._refreshVertexes()):f.updateGeom());b.removeListener(c.MOVE[a.type],this._onVertexDrag,this);b.removeListener(c.UP[a.type],this._onVertexDragEnd,this);this._drag=null}});
...
e.outline?e.outlineWidth:0;c+=2*(d||0);d=c*b/2;if(this.bbox&&(d=[this.bbox[0]-d,this.bbox[1]-d,this.bbox[2]+d,this.bbox[3]+d],!G.ExtentUtil.contains(d,a)))return!1;d=this.geom;var f,h,k,l=G.Graphic.Polyline.prototype._hitPointNowrap;if(e.outline||this._mouseOver)for(e=0,f=d.length;e<f;e++)if(h=d[e],k=[h[h.length-1],h[0]],h={geom:h,options:{lineWidth:c}},k={geom:k,options:{lineWidth:c}},l.call(h,a,b)||l.call(k,a,b))return!0;return G.GeomUtil._hitPolygon(a,d)},_refreshVertexes:function(){var a=this.geom,
...
a.mapY],d=this.virtualMouse,e=G.DomUtil,f=this._searchVertex(c);if(f){var h=b._handlers.Click;h&&h.off();var k=[f.geom[0],f.geom[1]],l=f._idVertex,h=l[0],l=l[1],n=[0,0];b.options.wrap&&(k=b._calcRealCoords(c),n[0]=k[0]-c[0],n[1]=k[1]-c[1],k=[k[0]+n[0],k[1]+n[1]]);f._isMid&&(f=this.geom[h].slice(0,l),f=f.concat([k]),f=f.concat(this.geom[h].slice(l)),this.geom[h]=f,this._refreshVertexes(),f=this._searchVertex(c));this._drag={vertex:f,wrapOffset:n,startAt:+new Date};e.stopPropagation(a);e.preventDefault(a);
b._handlers.Drag.off();b.addListener(d.MOVE[a.type],this._onVertexDrag,this);b.addListener(d.UP[a.type],this._onVertexDragEnd,this)}},_onVertexDrag:function(a){var b=this._layer._map,c=this._drag,d,e,f;if(c&&(d=c.vertex))for(wrapOffset=c.wrapOffset||[0,0],a=b._calcRealCoords([a.mapX,a.mapY]),c=[a[0]+wrapOffset[0],a[1]+wrapOffset[1]],b=d._idVertex,a=b[0],b=b[1],this.geom[a][b]=d.geom=c,this.updateGeom(),d.updateGeom(),c=b;c<=b+1;c++)if(e=0<c?c-1:this.geom[a].length-1,f=c>=this.geom[a].length?0:c,d=
this._midvertexes[a+","+f])d.geom=G.GeomUtil._middlePoint(this.geom[a][e],this.geom[a][f]),d.updateGeom()},_onVertexDragEnd:function(a){var b=this._layer._map,c=this.virtualMouse,d=G.DomUtil,e=b._handlers.Click;if(e)e.on();var e=this._drag,f,h;e&&(d.stopPropagation(a),d.preventDefault(a),b._handlers.Drag.on(),f=e.vertex)&&(h=f._idVertex,d=h[0],h=h[1],e=+new Date-e.startAt,200>e&&!f._isMid&&3<this.geom[d].length?(0==h?e=this.geom[d].slice(1,this.geom[d].length):h==this.geom[d].length-1?e=this.geom[d].slice(0,
h):(e=this.geom[d].slice(0,h),e=e.concat(this.geom[d].slice(h+1))),this.geom[d]=e,this.updateGeom(),this._refreshVertexes()):f.updateGeom());b.removeListener(c.MOVE[a.type],this._onVertexDrag,this);b.removeListener(c.UP[a.type],this._onVertexDragEnd,this);this._drag=null}});
...
a._map)&&(this._resDraw=null,this._updateGeomDraw(a._res))},_updateGeomDraw:function(a){var b=this.options,c=G.MathUtil,d=Math.sin,e=Math.cos,f=Math.max,h=Math.min,k=Math.PI;if(this._layer&&!(0<a&&this._resDraw==a)){for(var l=this.geom,n=l.length,m=c.calcDistance(l[n-1],l[n-2])/a,m=m>2*b.headSize?1:m/b.headSize/2,r=b.headSize*a*m,p=b.neckSize*a*m,m=b.neckAngle/c.DEGREE_PER_RADIAN,q=b.tailSize*a,w=b.tailAngle/c.DEGREE_PER_RADIAN,v=this.length-p*e(m),m=p*d(m),x=q*d(w),w=[],s=[],u=m-x,y,z,C,A,B,D,J=
0,m=0,K=n-1;m<K;m++)z=l[m],C=l[m+1],0==m?(y=c.calcTheta(z[0]-C[0],z[1]-C[1]),A=b.tailAngle/c.DEGREE_PER_RADIAN,B=[q*e(y-A),q*d(y-A)],w.push([z[0]+B[0],z[1]+B[1]]),B=[q*e(y+A),q*d(y+A)]):(y=l[m-1],D=x+u*J,A=c.calcTheta(z[0]-y[0],z[1]-y[1]),B=c.calcTheta(C[0]-z[0],C[1]-z[1]),y=(A+B)/2+k/2,A=(A-B)/2,A=e(A),D/=0.1>Math.abs(A)?0.1*(0<A?1:-1):A,B=[D*e(y),D*d(y)],w.push([z[0]+B[0],z[1]+B[1]]),B=[D*e(y+k),D*d(y+k)]),s.push([z[0]+B[0],z[1]+B[1]]),J+=c.calcDistance(z,C)/v;z=l[n-1];y=l[n-2];y=c.calcTheta(y[0]-
z[0],y[1]-z[1]);A=b.neckAngle/c.DEGREE_PER_RADIAN;B=[p*e(y-A),p*d(y-A)];w.push([z[0]+B[0],z[1]+B[1]]);B=[p*e(y+A),p*d(y+A)];s.push([z[0]+B[0],z[1]+B[1]]);A=b.headAngle/c.DEGREE_PER_RADIAN;B=[r*e(y-A),r*d(y-A)];w.push([z[0]+B[0],z[1]+B[1]]);B=[r*e(y+A),r*d(y+A)];s.push([z[0]+B[0],z[1]+B[1]]);b=[];b.push(l[0]);b=b.concat(w);b.push(l[n-1]);for(var b=b.concat(s.reverse()),E,F,H,I,m=0,n=b.length;m<n;m++)c=b[m],l=c[0],c=c[1],E=void 0===E?l:h(E,l),F=void 0===F?l:f(F,l),H=void 0===H?c:h(H,c),I=void 0===I?
...
{layer:this});a._requestRedraw();return this}},getOrder:function(){var a=this._map,b;for(b in a._layerOrder)if(a._layerOrder[b]==this._id)return b;return-1},bringToOrder:function(a){var b=this._map;if(void 0===a||0>a)return this;for(var c in b._layerOrder)if(b._layerOrder[c]==this._id){b._layerOrder.splice(c,1);break}b._layerOrder.splice(a,0,this._id);this._afterReorder();b._requestRedraw();return this},bringToTop:function(){var a=this._map,b;for(b in a._layerOrder)if(a._layerOrder[b]==this._id){a._layerOrder.splice(b,
1);break}a._layerOrder.push(this._id);this._afterReorder();a._requestRedraw();return this},bringToBottom:function(){var a=this._map,b;for(b in a._layerOrder)if(a._layerOrder[b]==this._id){a._layerOrder.splice(b,1);break}a._layerOrder=[this._id].concat(a._layerOrder);this._afterReorder();a._requestRedraw();return this},bringUp:function(a){var b=this._map,c;for(c in b._layerOrder)if(b._layerOrder[c]==this._id){b._layerOrder.splice(c,1);break}b._layerOrder.splice(c+(a?a:1),0,this._id);this._afterReorder();
b._requestRedraw();return this},bringDown:function(a){var b=this._map,c;for(c in b._layerOrder)if(b._layerOrder[c]==this._id){b._layerOrder.splice(c,1);break}b._layerOrder.splice(c-(a?a:1),0,this._id);this._afterReorder();b._requestRedraw();return this},hide:function(){var a=this._map;if(this._hidden)return this;this._hidden=!0;this._erase&&this._erase();a&&a._requestRedraw();return this},show:function(){var a=this._map;if(!this._hidden)return this;this._hidden=!1;a&&(a._requestRedraw(),a._requestUpdate());
return this},isVisible:function(){var a=this._map;if(this._hidden||!a)return!1;var b=this.options,c=b.minRes,b=b.maxRes,a=a._res;return b&&b<a||c&&c>a?!1:!0},_afterReorder:function(){var a=this._map,b,c,d;for(b in a._layerOrder)if(c=parseInt(b),d=a._layerOrder[c],d=a._layers[d])d._zIndex=c},clear:function(){return this},_onClear:function(){},_update:function(){},_draw:function(){},_erase:function(){},_onResize:function(a){},_onViewChanged:function(a){},_onAdded:function(){},_onRemoved:function(){},
_onZoomStart:function(a){},_onZoomUpdate:function(a){},_onZoom:function(a){},_onZoomEnd:function(a){},_onMoveStart:function(a){},_onMove:function(a){},_onMoveEnd:function(a){},_onRotateStart:function(a){},_onRotate:function(a){},_onRotateEnd:function(a){},_onPinchStart:function(a){},_onPinch:function(a){},_onPinchEnd:function(a){}});
...
maxRes:156543.033928,minRes:0.298582141738892},_calcVisTileInfos:function(a){var b=this._map,c=b.getSize(),d=b.getCenter(),e=this.options,f=b.options,h=Math.PI*b._rotate/180,k=e.tileSize;a=this._calcNearestZoom(a);for(var l=e.zoomReses[a],n=k*l,k=k*(l/b._res),m=Math.abs,r=Math.sin,p=Math.cos,l=m(c[0]*p(h))+m(c[1]*r(h)),h=m(c[0]*r(h))+m(c[1]*p(h)),c=Math.ceil(l/k/2),h=Math.ceil(h/k/2),k=this._calcTileIndex(d[0],d[1],a),p=k[0]-c,d=k[0]+c,c=k[1]-h,h=k[1]+h,k=-Math.max(b.options.tolerance||0,b._res/10),
l=void 0!==e.minX&&void 0!==e.minY&&void 0!==e.maxX&&void 0!==e.maxY,m=[],r=G.ExtentUtil.intersect([e.minX,e.minY,e.maxX,e.maxY],b.options.maxExtent),q,w,v,x,s=p;s<=d;s++){q=e.originX+s*n;w=q+n;p=s;f.wrap&&(q=b._calcRealCoords([q,0])[0],w=q+n,p=Math.round((q-e.originX)/n));for(var u=c;u<=h;u++){if(l&&(v=e.originY-(u+1)*n,x=e.originY-u*n,!G.ExtentUtil.overlaps([q,v,w,x],r,k)))continue;m.push([p,u,a])}}return m},_sortTileInfos:function(a,b,c){var d,e;a.sort(function(a,h){d=Math.pow(a[0]-b,2)+Math.pow(a[1]-
c,2);e=Math.pow(h[0]-b,2)+Math.pow(h[1]-c,2);return Math.abs(d-e)})},_calcNearestZoom:function(a){for(var b=this._map._res,c=this.options.zoomReses,d,e=0,f=0,h=c.length;f<h;f++){d=c[f];if(d<b)return a?f:e;if(d==b)return f;e=f}return 0},_calcTileIndex:function(a,b,c){var d=this.options;c=Number(d.zoomReses[c]);if(!c)return[-1,-1];c*=d.tileSize;return[Math.floor((a-d.originX)/c),Math.floor((d.originY-b)/c)]},_calcTileExtent:function(a,b,c){var d=this.options;if(c=Number(d.zoomReses[c]))return c*=d.tileSize,
a=c*a+d.originX,b=d.originY-c*b,[a,b-c,a+c,b]},_getTileName:function(a,b,c){return a+","+b+","+c},_getTileUrl:function(a,b,c,d){var e=this.url,f=G.Util,h=this.options.cluster;if(e){var k=d?d.scale||1:1,e=f.isFunction(e)?e(c,a,b,k):e,l;f.isArray(h)&&0<h.length&&(l=Math.abs(a+b)%h.length,l=h[l]);return f.renderString(e,G.Util.merge({s:l,z:c,x:a,y:b,i:1<k?"@2x":""},d))}},_tileOverlap:function(a,b){var c=this._calcTileExtent(a[0],a[1],a[2]),d=this._calcTileExtent(b[0],b[1],b[2]);return G.ExtentUtil.overlaps(c,
d)}};
...
b){this.url=a;this.options=G.Util.merge({},this.options,b);this._tiles={};this._idleTiles=[]},clear:function(){for(var a=this._map,b=this._tiles,c,d=0,e=b.length;d<e;d++)c=b[d],this._stopLoadingTile(c);this._tiles={};this._idleTiles=[];this._onClear();a&&a._requestUpdate();return this},_tileInfoExist:function(a,b){for(var c,d=0,e=b.length;d<e;d++)if(c=b[d],c[0]===a[0]&&c[1]===a[1]&&c[2]===a[2])return!0;return!1},_onAdded:function(){var a=this._map;this._container||this._initContainer();a._zoomReses=
this.options.zoomReses},_onRemoved:function(){var a=this._map;this._container&&this._destroyContainer();for(var b,c,d=0,e=a._layers.length;d<e;d++)if(c=a._layers[d],c instanceof G.Layer.Tile){b=c;break}b||delete a._zoomReses},_stopLoadingTiles:function(a){a=a.getElementsByTagName("img");for(var b,c=0,d=a.length;c<d;c++)b=a[c],this._stopLoadingTile(b)},_stopLoadingTile:function(a){if(a&&!a.complete){G.Browser.android||(a.onload=null,a.onerror=null,a.src="");var b=a.parentNode;b&&b.removeChild(a)}},
_removeTile:function(a){var b=this._tiles[a];if(b){this._stopLoadingTile(b);if(b._wraps){for(var c in b._wraps){var d=b._wraps[c];d&&d.parentNode&&d.parentNode.removeChild(d)}b._wraps={}}(c=b.parentNode)&&c.removeChild(b);this._onTileRemoved(b);G.DomUtil.removeClass(b,"g-tile-loaded");this._idleTiles.push(b);delete this._tiles[a]}},_resetTile:function(a){a._loaded=!1;a._responseTime=null;a._retried=0;a.src=""},_getIdleTile:function(){if(0<this._idleTiles.length){var a=this._idleTiles.pop();this._resetTile(a);
return a}return this._createTile()},_createTile:function(){var a=this.options,b=G.DomUtil.create("img","g-tile"),c=a.tileSize,d=G.Browser.getPxRatio();G.DomUtil.setSize(b,c/d[0],c/d[1]);b._retried=0;a.crossOrigin&&(b.crossOrigin=a.crossOrigin);return b},_placeTile:function(a,b,c,d,e){var f=G.Browser.getPxRatio(),h=f[0],f=f[1],k=this._map,l=k._rotate,n=k.getSize(),m=k.getCenter(),r=k._res,p=this.options,q=k.options,k=p.tileSize*p.zoomReses[d],l=p.tileEnlarge&&(!!(l%90)||G.Browser.gecko||G.Browser.safari),
l=Math.ceil(k/r)+(l?2:0),w=(p.originX+b*k-m[0])/r/h+n[0]/2;c=-(p.originY-c*k-m[1])/r/f+n[1]/2;var v=G.DomUtil;v.markScaleTransform(a,1/h,1/f);v.markPosTransform(a,w,c);v.markSizeTransform(a,l,l);v.updateTransform(a);v.updateOpacity(a,p.opacity);void 0===e&&(e=p.zoomReses.length,w=this._calcNearestZoom(!0),e=d==w?e+1:d);v.setZIndex(a,e);if(q.wrap&&!a._isWrap){var w=d=0,q=q.maxExtent,x=this._redrawExtent;if(x&&q){var s=q[2]-q[0],w=Math.floor((x[0]-p.minX)/s)-1;d=Math.ceil((x[2]-p.maxX)/s)+1}a._wraps=
a._wraps||{};for(var u in a._wraps)(u>d||u<w)&&(q=a._wraps[u])&&q.parentNode&&(q.parentNode.removeChild(q),delete a._wraps[u]);for(u=w;u<=d;u++)0!=u&&(q=a._wraps[u],q||(q=a._wraps[u]=G.DomUtil.create("img","g-tile"),q._isWrap=!0,v.addClass(q,"g-tile-wrap"),q.crossOrigin=a.crossOrigin,q.src=a.src,q._info=a._info,q._loaded=!0,v.addClass(q,"g-tile-loaded"),this._onNewWrapTile(a,u)),w=(p.originX+b*k-m[0]+u*s)/r/h+n[0]/2,v.markScaleTransform(q,1/h,1/f),v.markPosTransform(q,w,c),v.markSizeTransform(q,l,
l),v.updateTransform(q),v.updateOpacity(q,p.opacity),v.setZIndex(q,e))}},_checkAllHandled:function(){if(this._numLoad==this._numLoadSuccess+this._numLoadError){var a,b;for(b in this._tiles)a=this._tiles[b],a=G.DomUtil.getSize(a),a=a[0]/this.options.tileSize,(4<a||0.125>a)&&this._removeTile(b);this._clearBgBuffer();this.fireEvent("allLoaded")}},_loadTile:function(a,b,c,d,e){a._layer=this;a._info=[b,c,d];a._loaded=!1;a.onload=this._onTileLoad;a.onerror=this._onTileError;e||(a._retried=0,this.fireEvent("tileStart",
{tile:a,url:a.src}));a.src=this._getTileUrl(b,c,d,{scale:G.Browser.retina?2:1})},_onTileLoad:function(){var a=this._layer;this._responseTime=+new Date;var b=a.options.errorTileUrl||G.Layer.Tile.EMPTY_TILE,c,d;this.src!==b&&("naturalWidth"in this&&!this.naturalWidth?(d=this.src,this.src=b,a._numLoadError++,a.fireEvent("tileError",{tile:this,url:d})):(G.DomUtil.addClass(this,"g-tile-loaded"),this._loaded=!0,c=this._info,b=parseInt(c[0]),d=parseInt(c[1]),c=parseInt(c[2]),a._placeTile(this,b,d,c),a._numLoadSuccess++,
a.fireEvent("tileSuccess",{tile:this,url:this.src})),a._checkAllHandled())},_onTileError:function(){var a=this._layer;this._responseTime=+new Date;var b=a.options.errorTileUrl||G.Layer.Tile.EMPTY_TILE,c=this.src,d;this.src!==b&&(this._retried++<a.options.retryTimes?(d=this._info,b=parseInt(d[0]),c=parseInt(d[1]),d=parseInt(d[2]),a._loadTile(this,b,c,d,!0)):(this.src=b,a._numLoadError++,a.fireEvent("tileError",{tile:this,url:c}),a._checkAllHandled()))},_onTileRemoved:function(a){},_onNewWrapTile:function(a,
b){}});
G.Layer.Graphic=G.Layer.extend({init:function(a){this.options=G.Util.merge({},this.options,a);this._indexSeq=this._idSeq=0;this._graphics={};this._styles={};this._tree=new G.RTree},add:function(a,b,c){if(a instanceof G.Graphic)return a.addTo(this,b,c),a._id},get:function(a){return this._graphics[a]},all:function(){var a=this._tree.all(),b=[],c,d;for(c in a)d=a[c],d._isVertex||b.push(d);return b},query:function(a){var b=this._tree.search(a),c=[],d,e,f;for(d in b)e=b[d],f=e.bbox,G.ExtentUtil.overlaps(f,a)&&
!e._isVertex&&c.push(e);return c},count:function(){var a=this._tree.all(),b=0,c,d;for(c in a)d=a[c],d._isVertex||b++;return b},clear:function(){var a=this._map;this._graphics={};this._tree.clear();delete this._hitGraphic;this._onClear();a&&a._requestRedraw();return this},setStyle:function(a,b,c){var d=this._map,e=this._styles,f=this._graphics,h,k,l,n,m=[];if(a&&b){n=Math.min(a.length,b.length);for(h=0;h<n;h++)k=a[h],l=b[h],k=k+","+l,m.push(k);e[m.join(";")]=c}else e[""]=c;for(h in f)a=f[h],b=this._calcStyle(a),
a.updateOptions(b,!0);d&&d._requestRedraw();return this},clearStyles:function(a){var b=this._map,c=this._graphics;this._styles={};for(i in c)g=c[i],g.updateOptions(a,!0);b&&b._requestRedraw();return this},calcDataExtent:function(a){var b=this._graphics,c,d,e;for(d in b)e=b[d],e=e.bbox,c?(c[0]=e[0]<c[0]?e[0]:c[0],c[1]=e[1]<c[1]?e[1]:c[1],c[2]=e[2]>c[2]?e[2]:c[2],c[3]=e[3]>c[3]?e[3]:c[3]):c=[e[0],e[1],e[2],e[3]];c&&a&&(b=(c[0]+c[2])/2,d=(c[1]+c[3])/2,e=(c[2]-c[0])/2*a,a*=(c[3]-c[1])/2,c[0]=b-e,c[1]=
d-a,c[2]=b+e,c[3]=d+a);return c},_calcStyle:function(a){var b=this._styles;a=a.attrs;var c=b[""];if(!a)return c;var d,e,f,h,k,l;for(d in b)if(d){e=d.split(";");for(h in e)if((f=e[h])&&(f.indexOf&&f.substring)&&(k=f.indexOf(","),l=f.substring(0,k),f=f.substring(k+1),l=eval('"'+a[l]+'"'+f),!l))break;if(l){c=b[d];break}}return c},_initContainer:function(){},_destroyContainer:function(){this._container.parentNode.removeChild(this._container);delete this._container},_onAdded:function(){this._container||
this._initContainer();var a=this._map;a.addListener("mousemove",this._onMouseMove,this);a.addListener("click",this._onClick,this)},_onRemoved:function(){this._container&&this._destroyContainer();var a=this._map;a.removeListener("mousemove",this._onMouseMove,this);a.removeListener("click",this._onClick,this)},_onClear:function(){},_onZoomStart:function(){},_onZoomUpdate:function(){},_onZoomEnd:function(){},_vacuum:function(){var a=this._map;if(a){var b=a.getCenter(),c=a._res,d=a.getDrawSize(),a=d[0],
d=d[1],b=this._tree.search([b[0]-a*c/2,b[1]-d*c/2,b[0]+a*c/2,b[1]+d*c/2]),c={},e,d=this._graphics;for(e in d)c[e]=!0;for(e in b)a=b[e],delete c[a._id];for(e in c)a=d[e],a.remove();return c.length}},_sortIndex:function(a,b){return a&&b?a._index-b._index||0:0},_onMouseMove:function(a){var b=this._map,c=b._focusGraphic;if(c&&!c._layer)c._mouseOver=!1,b._focusGraphic=null;else{var d=b._handlers.Drag;if(!d||!d._dragging)if(this.isVisible()){var e=b.getRedrawExtent(),e=this._tree.search(e).sort(this._sortIndex).reverse();
a=[a.mapX,a.mapY];var f,h,k,l;f=0;for(h=e.length;f<h;f++)if(k=e[f],l=k.options,l.clickable)if((l=k._hitPoint(a,b._res,b._rotate))&&k._mouseOver)break;else if(l&&!k._mouseOver){c&&(c._mouseOver=!1,c._onMouseOut&&c._onMouseOut(),c._isVertex?c._graphic._onVertexMouseOut():this.fireEvent("graphicOut",{graphic:c}));k._mouseOver=!0;b._focusGraphic=k;k._onMouseOver&&k._onMouseOver();k._isVertex?k._graphic._onVertexMouseOver():this.fireEvent("graphicOver",{graphic:k});break}else!l&&k._mouseOver&&(k._mouseOver=
!1,k._onMouseOut&&k._onMouseOut(),k._isVertex?k._graphic._onVertexMouseOut():this.fireEvent("graphicOut",{graphic:c}),b._focusGraphic=null);if(b._focusGraphic)!d||(d._dragging||b._focusGraphic.options.allowPan)||d.off();else if(d&&!d._dragging)d.on();G.Browser.ielt9&&(G.DomUtil.hasClass(b._layersFrame,"g-clickable")||G.DomUtil.hasClass(b._layersFrame,"g-edit")?b._layersFrame.style.cursor="":b._layersFrame.style.cursor="default")}else c&&(c._mouseOver=!1,c._onMouseOut&&c._onMouseOut(),c._isVertex?
c._graphic._onVertexMouseOut():this.fireEvent("graphicOut",{graphic:c}))}},_onClick:function(a){var b=this._map;if(this.isVisible()){var c=b.getRedrawExtent(),c=this._tree.search(c).sort(this._sortIndex).reverse(),d=[a.mapX,a.mapY],e=b.options.touchTol,e=G.Browser.touch?e:0,f,h,k;for(h=0;h<c.length;h++)if(f=c[h],k=f.options,k.clickable&&f._hitPoint(d,b._res,b._rotate,e)){a.cancel();f._isVertex||this.fireEvent("graphicClicked",{graphic:f});break}}}});
...
b){this.url=a;this.options=G.Util.merge({},this.options,b);this._idSeq=0;this._images={}},addImage:function(a,b,c,d,e){var f=this._map,h=G.DomUtil.create("img","g-image",this._container),k=G.Browser.getPxRatio(),l=f._res;G.DomUtil.setSize(h,(d-b)/l/k[0],(e-c)/l/k[1]);h._id=this._idSeq++;h._addAt=+new Date;this._images[h._id]=h;h.geom=h.bbox=[b,c,d,e];h._src=a;this._loadImage(h);f&&f._requestRedraw();return h._id},getImage:function(a){return this._images[a]},removeImage:function(a){var b=this._images[a];
if(b){var c=b.parentNode;c&&c.removeChild(b);delete this._images[a];map&&map._requestRedraw();return this}},clear:function(){for(var a=this._map,b=this._images,c,d=0,e=b.length;d<e;d++)c=b[d],this._stopLoadingImage(c);this._images={};this._onClear();a&&a._requestUpdate();return this},_initContainer:function(){var a=this._map,b=G.DomUtil,c=this._container=b.create("div","g-layer g-image-container");a._layersFrame.appendChild(this._container);b.setZIndex(c,this._zIndex)},_destroyContainer:function(){this._container.parentNode.removeChild(this._container);
delete this._container},_onAdded:function(){this._container||this._initContainer()},_onRemoved:function(){this._container&&this._destroyContainer()},_update:function(){this.isVisible()?this._draw():this._erase()},_draw:function(){var a=G.DomUtil;a.show(this._container);a.setZIndex(this._container,this._zIndex);var a=this._images,b,c;for(b in a)c=a[b],this._placeImage(c)},_erase:function(){G.DomUtil.hide(this._container)},_placeImage:function(a){var b=G.DomUtil,c=G.Browser.getPxRatio(),d=c[0],c=c[1],
e=this._map,f=e._res,h=a.bbox,k=h[0],l=h[1],n=this._zoomScale||this._scale,m=this._aroundScreen,r=(h[2]-h[0])/f,f=(h[3]-h[1])/f;n&&1!==n&&(r/=n,f/=n);k=e.toScreen([k,l],m,n);e=k[0];k=k[1]-f;b.markScaleTransform(a,1/d,1/c);b.markPosTransform(a,e,k);b.markSizeTransform(a,r,f);b.updateTransform(a);b.updateOpacity(a,this.options.opacity)},_stopLoadingImages:function(a){a=a.getElementsByTagName("img");for(var b,c=0,d=a.length;c<d;c++)b=a[c],this._stopLoadingImage(b)},_stopLoadingImage:function(a){if(a&&
!a.complete){G.Browser.android||(a.onload=null,a.onerror=null,a.src="");var b=a.parentNode;b&&b.removeChild(a)}},_loadImage:function(a,b){a._layer=this;a._loaded=!1;a.onload=this._onImageLoad;a.onerror=this._onImageError;b||(a._retried=0,this.fireEvent("imageStart",{image:a,url:a.src}));a.src=a._src},_onImageLoad:function(){var a=this._layer;this._responseTime=+new Date;var b=a.options.errorTileUrl||G.Layer.Tile.EMPTY_TILE;if(this.src!==b)if("naturalWidth"in this&&!this.naturalWidth){var c=this.src;
this.src=b;a.fireEvent("imageError",{image:this,url:c})}else G.DomUtil.addClass(this,"g-image-loaded"),this._loaded=!0,a._placeImage(this),a.fireEvent("imageSuccess",{image:this,url:this.src})},_onImageError:function(){var a=this._layer;this._responseTime=+new Date;var b=a.options.errorImageUrl||G.Layer.Image.EMPTY_TILE,c=this.src;this.src!==b&&(this._retried++<a.options.retryTimes?a._loadImage(this,!0):(this.src=b,a.fireEvent("imageError",{image:this,url:c})))},_onImageRemoved:function(a){},_onNewWrapImage:function(a,
b){},_onZoomStart:function(a){var b=this._map,c=b._mapFrame,d=b.getSize(),e=b._rotate,f=G.DomUtil,h=f.Transition;this._zooming||(this._zooming=!0);var k=[d[0]/2,d[1]/2],d=a.aroundScreen||k,l=k[0]-d[0],n=k[1]-d[1];e&&(l&&n)&&(d=G.MathUtil.rotateVector([l,n],-e),d=[k[0]-d[0],k[1]-d[1]]);this._aroundScreen=d;this._scale=a.scale;b=b._zoomAnim&&b._zoomAnim._params.ignoreAnim;a=1/a.scale-1;var e=this._images,m,r,p;for(r in e)p=e[r],l=p._zoomStartPos=f.getPosition(p),p._zoomStartSize=f.getSize(p),k=l[0],
m=l[1],l=(k-d[0])*a,n=(m-d[1])*a,f.markPosTransform(p,k+l,m+n),f.updateTransform(p),b||(p.style[h]=c.style[h])},_onZoomUpdate:function(a){var b=G.DomUtil;if(this._zooming){var c=this._aroundScreen,d=this._scale=a.scale;a=1/a.scale-1;var e=this._images,f,h,k,l;for(k in e)if(l=e[k],f=l._zoomStartPos)h=f[0],f=f[1],dx=(h-c[0])*a,dy=(f-c[1])*a,size=l._zoomStartSize,b.markSizeTransform(l,size[0]/d,size[1]/d),b.markPosTransform(l,h+dx,f+dy),b.updateTransform(l)}},_onZoomEnd:function(){this._scale=1;var a=
this._images,b,c;for(b in a)c=a[b],this._placeImage(c);this._zooming=!1}});G.Anim=G.Class.extend({mixins:[G.Event],init:function(a){this._map=a;this._playing=!1;return this},start:function(){},update:function(){},stop:function(){}});
...
this._playing&&(this._playing=!1,clearTimeout(this._timer),G.Util.cancelAnimFrame(this._animFrame),b.style[c.Transition]="",c.removeClass(b,"g-pan-anim"),a._mergeFramePos(),a._updateUrl(),this._playing=!1,a.fireEvent("moveEnd"),a._requestUpdate(),G.DomDraggable.forbidden=G.DomPinchable.forbidden=!1)},_onTransitionEnd:function(){var a=G.DomUtil;a.removeListener(this._map._mapFrame,a.TransitionEnd,this._onTransitionEnd,this);this._final()}});
...
this._map,c=G.DomUtil,d=Math.abs,e=b.options.touchTol,f=(a||a.touches[0]).target;f;){if("g-popup"==f.className)return;f=f.parentElement}var h=this._lastDown,k=a.changedTouches?a.changedTouches[0]:a;h&&(f=b._mapFrame._pos,h=c.getMousePosition(h,b._container),c=c.getMousePosition(k,b._container),b=d(h[0]-c[0]-f[0]),d=d(h[1]-c[1]-f[1]),b<e&&d<e&&this._virtualClick(h,a));this._lastDown=null},_virtualClick:function(a,b){var c=this._map,d=c.toMap(a);c.fireEvent("virtualclick",{mapX:d[0],mapY:d[1],screenX:a[0],
screenY:a[1]});d=+new Date;c=1E3*c.options.doubleDuration;if(this._lastClick)if(d-this._lastClickTime<c)clearTimeout(this._clickTimeout),this._lastClick=null,this._realDoubleClick(a,b);else{if(b.touches&&2>this._touchesCount||1===b.which||1===b.button)this._lastClick=a,this._realClick()}else if(b.touches&&2>this._touchesCount||1===b.which||1===b.button)this._lastClick=a,this._clickTimeout=setTimeout(G.Util.bind(this._realClick,this),c);this._lastClickTime=d},_realDoubleClick:function(a,b){var c=this._map,
d=c.toMap(a),e;c.options.doubleZoom&&(e=b.touches&&2>this._touchesCount||1===b.which||1===b.button,this._doubleZoom(d,!e));c.fireEvent("doubleclick",{mapX:d[0],mapY:d[1],screenX:a[0],screenY:a[1]})},_doubleZoom:function(a,b){var c=this._map;if(c.options.doubleZoom){var d=c.getSize(),e=c._res,f=G.MathUtil.limitRange(c._calcNearestRes(b),c.options.minRes,c.options.maxRes);if(!(Math.abs(f-e)<e/100)){var e=f/e,h=d[0]*f,d=d[1]*f,f=c.getCenter(),k=a[0],l=a[1];c.zoomTo([k+(f[0]-k)*e,l+(f[1]-l)*e],h,d)}}},
_realClick:function(){var a=this._map;clearTimeout(this._clickTimeout);var b=this._lastClick,c=a.toMap(b);this._lastClick=null;this._lastClickTime=+new Date;a.fireEvent("click",{mapX:c[0],mapY:c[1],screenX:b[0],screenY:b[1]})},_showSpark:function(a){var b=this._map,c=G.DomUtil;if(!(b.isZooming()||b.isPanning()||b.isRotating())){var d=b.options.sparkOffset||[0,0],e=b.options.sparkDuration||1,f=b._spark;c.markPosTransform(f,a[0]+d[0],a[1]+d[1]);c.updateTransform(f);c.show(f,e,function(){c.hide(f)})}}});
...
(f[1]-l)*e],h,d)}}}});
G.Handler.Drag=G.Handler.extend({afterOn:function(){var a=this._map;this._draggable||(this._draggable=new G.DomDraggable(a._mapFrame,a._container),this._draggable.addListener("dragStart",this._onDragStart,this),this._draggable.addListener("drag",this._onDrag,this),this._draggable.addListener("dragEnd",this._onDragEnd,this),this._draggable.on())},afterOff:function(){this._draggable&&(this._draggable.off(),this._draggable.removeListener("dragStart",this._onDragStart,this),this._draggable.removeListener("drag",this._onDrag,
this),this._draggable.removeListener("dragEnd",this._onDragEnd,this),delete this._draggable)},_onDragStart:function(a){var b=this._map,c=G.DomUtil,d=b._mapFrame,e=b.options;b._panAnim&&b._panAnim.stop();if(!(b.isZooming()||(b.isPanning()||b.isRotating())||this._dragging)){this._dragging=!0;c.preventDefault(a);c.stopPropagation(a);d.style[c.Transition]="";e.panAnim&&(this._poses=[],this._times=[]);this._mergedFramePos=[0,0];var f,h,k,l,n,m;n=Math.abs;m=Math.sin;var r=Math.cos,c=Math.round;if(d=e.maxExtent)a=
b.getSize(),a=[0,0,a[0],a[1]],f=b._res,h=(d[2]-d[0])/2/f,k=(d[3]-d[1])/2/f,(f=b._rotate)?(l=f/G.MathUtil.DEGREE_PER_RADIAN,f=n(h*r(l))+n(k*m(l)),n=n(h*m(l))+n(k*r(l))):(f=h,n=k),d=b.toScreen([(d[2]+d[0])/2,(d[3]+d[1])/2]),m=[c(d[0]-f),c(d[1]-n),c(d[0]+f),c(d[1]+n)],c=m[0]>a[0]?a[0]-m[0]:a[2]-m[2],d=m[3]<a[3]?a[3]-m[3]:a[1]-m[1],n=m[2]<a[2]?a[2]-m[2]:a[0]-m[0],a=m[1]>a[1]?a[1]-m[1]:a[3]-m[3],e.wrap&&(c=-Number.MAX_VALUE,n=Number.MAX_VALUE),this._draggable._dLimit=[c,d,n,a];b.fireEvent("moveStart")}},
...
0,b:parseInt(a.b.currentStyle["border-top-width"])||0};b._container.style.cursor="crosshair";d(document,"mousemove",this._onMouseMove,this);d(document,"mouseup",this._onMouseUp,this);b.fireEvent("shiftDragStart")},_onMouseMove:function(a){var b=this._map,c=b.getSize(),d=b.getDrawSize(),e=b._isCanvasRelMode(),f=e?c[0]:d[0],h=e?c[1]:d[1],k=G.DomUtil,l=k.setPosition,n=k.setSize,m=Math.min,r=Math.max,p=Math.abs,q=this._box,w=this._boxBorders,v=this._startScreen,x=k.getMousePosition(a,b._container),s=
r(0,p(x[0]-v[0])-w.l-w.r),r=r(0,p(x[1]-v[1])-w.t-w.b),p=m(x[0],v[0]),m=m(x[1],v[1]),x=v=0;e||(e=b.getCenter(),v=b._res,b=b.toScreen([e[0]-v*d[0]/2,e[1]+v*d[1]/2],0,0,!0),v=b[0],x=b[1],p-=(d[0]-c[0])/2,m+=(d[1]-c[1])/2);v=parseInt(v);x=parseInt(x);s=parseInt(s);r=parseInt(r);p=parseInt(p);m=parseInt(m);k.preventDefault(a);k.stopPropagation(a);0>p&&(s+=p,p=0);0>m&&(r+=m,m=0);a=f-p-w.l-w.r;w=h-m-w.t-w.b;s=s>a?a:s;r=r>w?w:r;l(q.lt,v,x);n(q.lt,p,m);l(q.rt,v+p+s,x);n(q.rt,f-p-s,m);l(q.lb,v,x+m+r);n(q.lb,
p,h-m-r);l(q.rb,v+p+s,x+m+r);n(q.rb,f-p-s,h-m-r);l(q.l,v,x+m);n(q.l,p,r);l(q.r,v+p+s,x+m);n(q.r,f-p-s,r);l(q.t,v+p,x);n(q.t,s,m);l(q.b,v+p,x+m+r);n(q.b,s,h-m-r)},_onMouseUp:function(a){var b=this._map,c=b._res,d=b._rotate,e=d/G.MathUtil.DEGREE_PER_RADIAN,f=G.DomUtil,h=f.removeListener,k=this._startScreen,l=f.getMousePosition(a,b._container);f.preventDefault(a);f.stopPropagation(a);for(var n in this._box)b._mapFrame.removeChild(this._box[n]);b._container.style.cursor="";f.enableTextSelection();f.enableImageDrag();
...
!1,this._final(),a.fireEvent("pinchEnd"),!a.options.continuouslyZoom)){var e=this._startRes,b=a._res;if(!(Math.abs(e-b)<b/1E4||(d=G.MathUtil.limitRange(a._calcNearestRes(b>e),c,d),Math.abs(d-b)<b/1E4))){var c=d/b,e=a.getSize(),b=e[0]*d,d=e[1]*d,e=a.getCenter(),f=this._pinchStartMap[0],h=this._pinchStartMap[1];this._newCenter=[f+(e[0]-f)*c,h+(e[1]-h)*c];this._newWidth=b;this._newHeight=d;a.zoomTo(this._newCenter,this._newWidth,this._newHeight,{fireEnd:!0})}}},_temp:function(a){var b=this._map,c=b.options,
d=c.minRes,e=c.maxRes,f=b.getSize(),h=G.MathUtil,k=Math.max,l=G.DomUtil.getMousePosition(a.originTouch1,b._container),n=G.DomUtil.getMousePosition(a.originTouch2,b._container);a=l[0];var l=l[1],m=n[0],r=n[1],n=h.calcHypotenuse(a-m,l-r),p;c.pinchRotate&&(c=h.calcTheta(a-m,l-r),p=c-this._pinchStartRotate,this._rotating||(this._pinchStartRotate=c,this._rotating=!0,b.fireEvent("rotateStart"),p=0));var q=this._pinchStartDis,c=n-q,k=k(k(f[0]/2,f[1]/2),q),k=Math.pow(2,-c/k);a=[(a+m)/2,(l+r)/2];this._zooming||
(this._pinchStart=a,this._pinchStartMap=b.toMap(this._pinchStart),this._pinchStartDis=n,this._zooming=!0,b.fireEvent("zoomStart"),k=1);d=h.limitRange(k*this._startRes,d,e);a=[a[0]-f[0]/2,a[1]-f[1]/2];a=h.rotateVector(a,-b._rotate);this._rotating&&(a=h.rotateVector(a,p*h.DEGREE_PER_RADIAN));k=this._pinchStartMap;e=k[0]-a[0]*d;a=k[1]+a[1]*d;k=this._startRotate;this._rotating&&(k=this._startRotate+p*h.DEGREE_PER_RADIAN);this._newCenter=[e,a];this._newWidth=f[0]*d;this._newHeight=f[1]*d;b._rawView(this._newCenter,
this._newWidth,this._newHeight,k);this._rotating&&b.fireEvent("rotate");this._zooming&&b.fireEvent("zoom");b._requestRedraw()},_final:function(){var a=this._map;this._rotating&&a.fireEvent("rotateEnd");this._zooming&&a.fireEvent("zoomEnd");a._requestUpdate()}});
G.Map=G.Class.extend({mixins:[G.Event],options:{srid:3857,wrap:!0,minRes:0.298582141738892,maxRes:156543.033928,maxExtent:[-2.0037508342784E7,-2.0037508342784E7,2.0037508342784E7,2.0037508342784E7],scrollPage:!1,zoomAnim:!0,zoomAnimDuration:0.3,panAnim:!0,panAnimMaxSpeed:1E3,panAnimDuration:0.3,panAnimEase:0.3,rotateAnim:!0,rotateAnimDuration:0.3,tolerance:1E-5,topZIndex:100,doubleDuration:0.3,sparkDuration:1,hideLogo:!1,doubleZoom:!0,pinchZoom:!0,pinchRotate:!0,dragPan:!0,shiftZoom:!0,scrollZoom:!0,
continuouslyZoom:!0,touchTol:8,recordStatus:!0,mask:!1,maskColor:"#000",maskOpacity:1,canvasAnimRedraw:!1,canvasExpandFactor:0.25,glColor:"#fff",initStatus:{center:[0,0],res:156543.033928,rotate:0}},init:function(a,b){var c=this._container=G.DomUtil.get(a);this.options=G.Util.merge({},this.options,b);if(!c)throw Error("No map container!");c._initBy!==G.name&&(this._initLayout(),this._initListeners(),this._initHandlers(),this._initAddition(),c._initBy=G.name,this._onResize(),this.fireEvent("resize"));
this._center=this.options.initStatus.center||[0,0];this._res=this.options.initStatus.res||156543.033928;this._rotate=this.options.initStatus.rotate||0;this._extent=[];this._layerIdSeq=0;this._layers={};this._layerOrder=[];this._masks=[];this._rotate&&(this._updateCompass(this._rotate),this._updateDrawSize());this._ensureViewByUrl()},redraw:function(){this._requestRedraw();return this},getExtent:function(a){var b=this.getSize(),c=this.getCenter(),d=this._res,e=a||0;a=b[0]*d/2+e;b=b[1]*d/2+e;return[c[0]-
a,c[1]-b,c[0]+a,c[1]+b]},getRedrawExtent:function(a){var b=this.getDrawSize(),c=this.getCenter(),d=this._res,e=this.options,f=this._isCanvasRelMode()?1+2*e.canvasExpandFactor:1,h=a||0;a=(b[0]*d/2+h)*f;d=(b[1]*d/2+h)*f;b=c[0]-a;a=c[0]+a;c=[b,c[1]-d,a,c[1]+d];e.wrap&&(e=e.maxExtent,d=e[0],f=e[2],d>b&&d<a||f>b&&f<a)&&(c[0]=e[0],c[2]=e[2]);return c},getRotate:function(){return this._rotate},getSize:function(){if(!this._size){var a=this._container;a&&(this._size=[a.offsetWidth,a.offsetHeight])}return this._size},
getDrawSize:function(){this._drawSize||this._updateDrawSize();return this._drawSize},getLayers:function(){return this._layers},getLayer:function(a){return this._layers[a]},addLayer:function(a){if(a instanceof G.Layer)return a.addTo(this),a._id},addMask:function(a){if(a instanceof G.Graphic.Polygon||a instanceof G.Graphic.Circle)a._map=this,this._masks.push(a),this._requestRedraw();return this},clearMask:function(){this._masks=[];this._requestRedraw();return this},view:function(a,b,c,d){this._rawView(a,
b,c,d);this._updateUrl();this._requestUpdate()},centerAt:function(a,b){var c=this._res,d=this._size;return this.zoomTo(a,d[0]*c,d[1]*c,b)},zoomTo:function(a,b,c,d){var e=this.options,f=this._size,h=e.maxRes,k=e.minRes,l=h?f[1]*h:c,n=k?f[1]*k:c;d={center:a,width:G.MathUtil.limitRange(b,k?f[0]*k:b,h?f[0]*h:b),height:G.MathUtil.limitRange(c,n,l),duration:d&&void 0!==d.duration?d.duration:e.zoomAnimDuration,fireEnd:d&&void 0!==d.fireEnd?d.fireEnd:!0,ignoreAnim:d&&void 0!==d.ignoreAnim?d.ignoreAnim:!1};
e.zoomAnim&&!G.Browser.ielt9?(this._zoomAnim=this._zoomAnim||new G.Anim.Zoom(this),this._zoomAnim._playing?this._zoomAnim.update(d):this._zoomAnim.start(d)):(this.fireEvent("zoomStart"),this._rawZoomTo(a,b,c),this._updateUrl(),this.fireEvent("zoomEnd"),this._requestUpdate());return this},zoomRes:function(a,b,c){if(!b)return this;var d=this.getSize();return this.zoomTo(a,d[0]*b,d[1]*b,c)},zoomExtent:function(a,b){var c=this.options;if(!a)return this;var d=this.getSize(),e=(a[0]+a[2])/2,f=(a[1]+a[3])/
2,h=a[2]-a[0],k=a[3]-a[1],l=Math.max(h/d[0],k/d[1]),n=l,m=this._zoomReses;if(!c.continuouslyZoom&&m){d=0;for(h=m.length;d<h&&!(c=m[d],c<l);d++)n=c;return this.zoomRes([e,f],n,b)}h&&k||(n=this._res,h=d[0]*n,k=d[1]*n);return this.zoomTo([e,f],h,k,b)},zoomIn:function(a){var b=this.getSize(),c=this._res,d=G.MathUtil.limitRange(this._calcNearestRes(),this.options.minRes,this.options.maxRes);if(!(Math.abs(d-c)<c/1E4))return c=b[0]*d,b=b[1]*d,d=this.getCenter(),this.zoomTo(d,c,b,a)},zoomOut:function(a){var b=
this.getSize(),c=this._res,d=G.MathUtil.limitRange(this._calcNearestRes(1),this.options.minRes,this.options.maxRes);if(!(Math.abs(d-c)<c/1E4))return c=b[0]*d,b=b[1]*d,d=this.getCenter(),this.zoomTo(d,c,b,a)},panBy:function(a,b,c){var d=this.options;d.panAnim&&!G.Browser.ielt9?(this._panAnim||(this._panAnim=new G.Anim.Pan(this)),this._panAnim.start({offsetX:a||0,offsetY:b||0,duration:c&&void 0!==c.duration?c.duration:d.panAnimDuration,ease:c&&void 0!==c.ease?c.ease:d.panAnimEase})):(this.fireEvent("moveStart"),
this._rawPanBy(a,b),this._updateUrl(),this.fireEvent("moveEnd"),this._requestUpdate());return this},rotateTo:function(a,b){var c=this.options;c.rotateAnim&&!G.Browser.ielt9?(this._rotateAnim||(this._rotateAnim=new G.Anim.Rotate(this)),this._rotateAnim.start({to:a||0,duration:b&&void 0!==b.duration?b.duration:c.rotateAnimDuration})):(this.fireEvent("rotateStart"),this._rawRotateTo(a||0),this._updateUrl(),this.fireEvent("rotateEnd"),this._requestUpdate());return this},isZooming:function(){var a=this._zoomAnim;
return a&&a._playing},isPanning:function(){var a=this._panAnim;return a&&a._playing},isRotating:function(){var a=this._rotateAnim;return a&&a._playing},isDragging:function(){var a=this._handlers.Drag;return a&&a._dragging},isPinching:function(){var a=this._handlers.Pinch;return a&&a._pinching},getCenter:function(){return this._center},getResolution:function(){return this._res},toScreen:function(a,b,c,d){var e=this.getSize(),f=this.getCenter(),h=this._res,k=this._rotate,l=e[0]/2,e=e[1]/2,n=G.Browser.getPxRatio(),
m=l+(a[0]-f[0])/h/n[0];a=e-(a[1]-f[1])/h/n[1];b&&(c&&1!==c)&&(c=1/c-1,m+=(m-b[0])*c,a+=(a-b[1])*c);b=m-l;c=a-e;k&&(b&&c&&!d)&&(d=G.MathUtil.rotateVector([b,c],k),m=d[0]+l,a=d[1]+e);return[m,a]},toMap:function(a,b){var c=this.getSize(),d=this.getCenter(),e=this._res,f=this._rotate,h=c[0]/2,k=c[1]/2,l=G.Browser.getPxRatio(),c=l[0],l=l[1],h=a[0]-h,k=a[1]-k;f&&(h&&k&&!b)&&(f=G.MathUtil.rotateVector([h,k],-f),h=f[0],k=f[1]);return[h*e*c+d[0],-k*e*l+d[1]]},showPopup:function(a,b,c,d){var e=G.DomUtil;b&&
(this._popupContentWrapper.innerHTML=b);b=this._popup;b._mapPoint=a;b._offsetX=c||0;b._offsetY=d||0;this._updatePopupPos();e.show(b);this.fireEvent("popupShown");return this},hidePopup:function(a){var b=this._popup;b._mapPoint=null;G.DomUtil.hide(b);a&&(this._popupContentWrapper.innerHTML="");this.fireEvent("popupHidden");return this},isPrintable:function(){if("canvas"!=this._mode&&"webgl"!=this._mode)return!1;var a,b;for(a in this._layers)if(b=this._layers[a])if(b=b.options.crossOrigin,void 0!==
b&&"*"!==b)return!1;return!0},destroy:function(){var a=this._container,b=G.DomUtil,c=G.DomUtil.removeListener,d,e;for(d in this._layers)this._layers[d].remove();var f=this._mouseEvents;d=0;for(e=f.length;d<e;d++)c(a,f[d],this._onMouseEvent,this);c(this._popup,"mouseenter",b.stopPropagation);c(this._popup,"mousemove",b.stopPropagation);c(this._popup,"mouseleave",b.stopPropagation);c(this._popup,"mousedown",b.stopPropagation);c(this._popupClose,"click",this._onPopupCloseDown,this);c(this._popupClose,
"mousedown",this._onPopupCloseDown,this);c(this._popupClose,"touchstart",this._onPopupCloseDown,this);c(this._compass,"click",this._onCompassDown,this);c(this._compass,"mousedown",this._onCompassDown,this);c(this._compass,"touchstart",this._onCompassDown,this);c(window,"contextmenu",this._onWinContextMenu,this);c(window,"resize",this._onWinResize,this);c(window,"hashchange",this._onWinHashChange,this);b.removeClass(a,"g-container");b.remove(this._mapFrame,a);b.remove(this._panelFrame,a);a._initBy=
void 0;return this},_initLayout:function(){var a=G.DomUtil,b=G.Browser;a.addClass(this._container,"g-container");b.retina&&a.addClass(this._container,"retina");b.ielt9&&a.addClass(this._container,"ielt9");this._mapFrame=a.create("div","g-map-frame",this._container);this._layersFrame=a.create("div","g-layers-frame",this._mapFrame);var c=this._popup=a.create("div","g-popup",this._mapFrame),d=a.create("div","g-popup-wrapper",c);this._popupClose=a.create("div","g-popup-close",d);d=a.create("div","g-popup-content",
d);this._popupContentWrapper=a.create("div","g-popup-content-wrapper",d);this._popupPointer=a.create("div","g-popup-pointer",c);a.hide(c);this._maskFrame=a.create("div","g-mask-frame",this._mapFrame);this._panelFrame=a.create("div","g-panel-frame",this._container);b.ielt9?(b=a.createVML("group","",this._panelFrame),this._compass=a.createVML("image","g-vml g-compass",b)):this._compass=a.create("div","g-compass",this._panelFrame);a.hide(this._compass);this._spark=a.create("div","g-spark",this._panelFrame);
this.options.hideLogo||(b=this._brand=a.create("div","g-brand",this._panelFrame),c=a.create("img","",b),b.style.left="8px",b.style.bottom="4px",b.style.position="absolute",c.style.width="24px",c.style.height="24px",c.src="data:image/png;base64,");
a.markPosTransform(this._mapFrame,0,0);a.updateTransform(this._mapFrame)},_initListeners:function(){for(var a=G.DomUtil,b=G.DomUtil.addListener,c=this._mouseEvents="click dblclick mousedown mousemove mouseup mouseenter mouseleave mousewheel DOMMouseScroll touchstart touchmove touchend".split(" "),d=0,e=c.length;d<e;d++)b(this._container,c[d],this._onMouseEvent,this);b(this._popup,"mouseenter",a.stopPropagation);b(this._popup,"mousemove",a.stopPropagation);b(this._popup,"mouseleave",a.stopPropagation);
b(this._popup,"mousedown",a.stopPropagation);b(this._popupClose,"click",this._onPopupCloseDown,this);b(this._popupClose,"mousedown",this._onPopupCloseDown,this);b(this._popupClose,"touchstart",this._onPopupCloseDown,this);b(this._compass,"click",this._onCompassDown,this);b(this._compass,"mousedown",this._onCompassDown,this);b(this._compass,"touchstart",this._onCompassDown,this);this._brand&&(b(this._brand,"click",this._onBrandDown,this),b(this._brand,"mousedown",this._onBrandDown,this),b(this._brand,
"touchstart",this._onBrandDown,this));b(window,"contextmenu",this._onWinContextMenu,this);b(window,"resize",this._onWinResize,this);b(window,"hashchange",this._onWinHashChange,this);this.addListener("zoomStart",this._onZoomStart,this);this.addListener("zoomUpdate",this._onZoomUpdate,this);this.addListener("zoom",this._onZoom,this);this.addListener("zoomEnd",this._onZoomEnd,this);this.addListener("moveStart",this._onMoveStart,this);this.addListener("move",this._onMove,this);this.addListener("moveEnd",
this._onMoveEnd,this);this.addListener("rotateStart",this._onRotateStart,this);this.addListener("rotate",this._onRotate,this);this.addListener("rotateEnd",this._onRotateEnd,this);this.addListener("pinchStart",this._onPinchStart,this);this.addListener("pinch",this._onPinch,this);this.addListener("pinchEnd",this._onPinchEnd,this)},_initHandlers:function(){var a=this.options;this._handlers={};this._handlers.Click=new G.Handler.Click(this);a.doubleZoom&&G.Browser.ielt9&&(this._handlers.DoubleClick=new G.Handler.DoubleClick(this));
a.pinchZoom&&(this._handlers.Pinch=new G.Handler.Pinch(this));a.dragPan&&(this._handlers.Drag=new G.Handler.Drag(this));a.shiftZoom&&(this._handlers.ShiftDrag=new G.Handler.ShiftDrag(this));a.scrollZoom&&(this._handlers.ScrollWheel=new G.Handler.ScrollWheel(this));this._resetHandlers()},_resetHandlers:function(){var a=this.options;this._handlers.Click.on(1);if(a.doubleZoom&&G.Browser.ielt9)this._handlers.DoubleClick.on(1);if(a.pinchZoom)this._handlers.Pinch.on(1);if(a.dragPan)this._handlers.Drag.on(1);
if(a.shiftZoom)this._handlers.ShiftDrag.on(1);if(a.scrollZoom)this._handlers.ScrollWheel.on(1)},_initAddition:function(){},_isCanvasRelMode:function(){return"canvas"==this._mode||"webgl"==this._mode},_isLoaded:function(){return this._center&&0<this._res},_updateCompass:function(a){var b=G.DomUtil,c=this._compass;b.markRotateTransform(c,a);b.updateTransform(c);if(G.Browser.ielt9){c.style.rotation=a;var d=c.currentStyle.src;c.src=d.substring(1,d.length-1)}a?b.show(c,this.options.rotateAnimDuration):
b.hide(c,0.5)},_updateDrawSize:function(){var a=this.getSize();if(a&&2==a.length){var b=a[0],a=a[1],c=Math.abs,d=Math.sin,e=Math.cos,f=this._rotate,h;f?(h=f/G.MathUtil.DEGREE_PER_RADIAN,f=c(b*e(h))+c(a*d(h)),b=c(b*d(h))+c(a*e(h))):(f=b,b=a);this._drawSize=[f,b]}},_onMouseEvent:function(a){var b=G.DomUtil;if(this._isLoaded()){var c=a.type,d=G.DomUtil.getMousePosition(a,this._container),e=this.toMap(d);if("click"!=c||G.Browser.chromelite){for(var f=(a||a.touches[0]).target;f;){if("g-popup"==f.className)return;
f=f.parentElement}"DOMMouseScroll"==c&&(c="mousewheel");"mousewheel"==c&&this.options.scrollPage||b.preventDefault(a);this.fireEvent(c,{mapX:e[0],mapY:e[1],screenX:d[0],screenY:d[1],originEvent:a})}}},_onPopupCloseDown:function(a){var b=G.DomUtil;b.stopPropagation(a);b.preventDefault(a);this.hidePopup(!0)},_onCompassDown:function(a){var b=G.DomUtil;b.stopPropagation(a);b.preventDefault(a);this.rotateTo(0)},_onBrandDown:function(a){var b=G.DomUtil;b.stopPropagation(a);b.preventDefault(a);window.location.href=
"http://geohey.com"},_onWinContextMenu:function(a){G.DomUtil.preventDefault(a)},_onWinResize:function(){var a=this._container;this._size=[a.offsetWidth,a.offsetHeight];this.view(this._center,this._width,this._height,this._rotate);this._onResize();this.fireEvent("resize")},_onWinHashChange:function(){this.options.recordStatus&&this._ensureViewByUrl()},_requestRedraw:function(){var a=G.Util;a.cancelAnimFrame(this._redrawAnimFrame);this._redrawAnimFrame=a.requestAnimFrame(this._redraw,!0,this)},_redraw:function(){var a,
b;for(a in this._layerOrder)b=this._layerOrder[a],(b=this._layers[b])&&(b.isVisible()?b._draw():b._erase());this._drawMask()},_requestUpdate:function(){var a=G.Util;a.cancelAnimFrame(this._updateAnimFrame);this._updateAnimFrame=a.requestAnimFrame(this._update,!0,this)},_update:function(){var a,b;for(a in this._layers)b=this._layers[a],b.isVisible()&&b._update();this._drawMask()},_onResize:function(){this._updateDrawSize();this._requestUpdate()},_rawZoomTo:function(a,b,c){a=this._center=this._calcRealCoords(a);
b&&c&&(this._res=this._calcResByViewport(a,b,c));this._updatePopupPos()},_rawPanBy:function(a,b){var c=G.DomUtil,d=this._mapFrame,e=c.getPosition(d);c.markPosTransform(d,-e[0]+a,e[1]-b);c.updateTransform(d);this._updatePopupPos()},_rawRotateTo:function(a,b){for(var c=G.DomUtil,d=this.getSize(),e=this._mapFrame;180<a;)a-=360;for(;-180>a;)a+=360;var f=b;!f&&e._rotate&&(f=[e._rotate[1],e._rotate[2]]);f||(f=[d[0]/2,d[1]/2]);this._rotate=a;d=this._mode;"webgl"!=d&&"canvas"!=d&&(c.markRotateTransform(e,
a,f[0],f[1]),c.updateTransform(e));this._updateCompass(a);this._updateDrawSize();this._updatePopupPos()},_rawView:function(a,b,c,d){this._rawRotateTo(d||0);this._rawZoomTo(a,b,c);this.fireEvent("viewChanged")},_updatePopupPos:function(){var a=G.DomUtil,b=this._popup,c=b._mapPoint;if(c){var c=this.toScreen(c),d=a.getSizeNocache(b),e=a.getSizeNocache(this._popupPointer);a.markPosTransform(b,c[0]-d[0]/2+b._offsetX,c[1]-d[1]-e[1]+b._offsetY);a.updateTransform(b)}},_mergeFramePos:function(){var a=this,
b=a._res,c=a._center,d=a._rotate,e=G.DomUtil,f=a._mapFrame,h=e.getPosition(f),k=h[0]*b,h=h[1]*b,b=c[0]-k,l=c[1]+h;0!==d&&(0!==k&&0!==h)&&(d=G.MathUtil.rotateVector([k,h],-d),b=c[0]-d[0],l=c[1]+d[1]);a._center=a._calcRealCoords([b,l]);G.Util.requestAnimFrame(function(){a._beforeMergeFramePos();e.markPosTransform(f,0,0);e.updateTransform(f);a._updatePopupPos()},!0,a)},_beforeMergeFramePos:function(){},_calcWrapPointRange:function(a){var b=0,c=0;a=a[0];var d=this.getExtent(),e=this.options,f=e.maxExtent;
e.wrap&&f&&(b=f[2]-f[0],c=Math.floor((d[0]-a)/b),b=Math.ceil((d[2]-a)/b));return[c,b]},_calcRealCoords:function(a){if(a){var b=this.options,c=b.maxExtent,d=0;if(b.wrap&&c){for(d=c[2]-c[0];a[0]<=c[0];)a[0]+=d;for(;a[0]>=c[2];)a[0]-=d}return a}},_calcResByViewport:function(a,b,c){a=this.getSize();return Math.max(b/a[0],c/a[1])},_calcNearestRes:function(a){var b=this._res,c=this._zoomReses,d;if(c)for(var e=0,f=0,h=c.length;f<h;f++){d=c[f];if(Math.abs(d-b)<b/100)return b=f+1>=h?h-1:f+1,a?c[e]:c[b];if(d<
...
a=(0<e?d.substring(0,e):d)+"!g_vs=!"+b[0]+"!"+b[1]+"!"+a+"!"+c;if((c=window.history)&&c.pushState){if(b=c.state?c.state.uri:null,a!=b)try{c.pushState({uri:a},null,a)}catch(f){}}else b=window.location.href,a!=b&&(window.location.href=a)}}},print:function(){},_drawMask:function(){},_onZoomStart:function(a){},_onZoomUpdate:function(a){},_onZoom:function(a){},_onZoomEnd:function(a){},_onMoveStart:function(a){},_onMove:function(a){},_onMoveEnd:function(a){},_onRotateStart:function(a){},_onRotate:function(a){},
_onRotateEnd:function(a){},_onPinchStart:function(a){},_onPinch:function(a){},_onPinchEnd:function(a){}});G.Proj={};
