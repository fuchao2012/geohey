var G={name:"Mlog",version:"1.0.0",owner:"mlogcn.com"};window.G=G;var cons=window.console;cons&&(cons.log("%c","font-size:30px; padding:15px 120px;line-height:60px;background:url('http://www.mlogcn.com/images/sprite.png') -362px -446px no-repeat;"),cons.log(G.name,G.version,"\u00a9",G.owner));
